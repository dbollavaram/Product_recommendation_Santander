...
Definition of the class dataset for handling the Santander competition dataset from Kaggle:
https://www.kaggle.com/c/santander-product-recommendation/data 
We need to recommend products to customers based on their history of purchases and different attributes like gender, customer segment, salary, location etc. 
"""
